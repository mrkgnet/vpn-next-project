        ...
        <table className="w-full text-right border-collapse">
          <thead>
            <tr className="bg-gray-50 border-b border-gray-100">
              ...
              <th className="px-6 py-4 text-sm font-semibold text-gray-600">نام و نام خانوادگی </th>
              <th className="px-6 py-4 text-sm font-semibold text-gray-600"> زمان اخرین پرداخت </th>
