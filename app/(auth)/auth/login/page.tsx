...
const AuthPage = () => {
  ...
  // --- Format Timer (mm:ss) ---
  // تعیین تایپ number برای پارامتر time جهت رفع خطای بیلد
      ...
      >
        <div className="bg-white/80 backdrop-blur-xl border border-white/20 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-hidden">
              ...
              {step === "verify" && (
                ...
                >
                  <input
                    ...
                    placeholder="- - - - -"
                    className="w-full py-2 bg-gray-50 border border-gray-300 focus:bg-white focus:border-rose-500 rounded-xl outline-none transition-all text-center text-xl tracking-[0.5em] font-bold text-gray-600 placeholder:text-gray-300"
                    dir="ltr"
                  />
          ...
          <div className="bg-gray-50/50 p-4 text-center border-t border-gray-100">
            <p className="text-xs text-gray-400">با ورود به سایت، قوانین را می‌پذیرید.</p>
          </div>
        </div>
      </motion.div>
    </div>
